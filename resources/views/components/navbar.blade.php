<nav id="navbar"
     class="fixed top-0 left-0 w-full z-50 transition-all duration-300 bg-transparent backdrop-blur-md">
    <div class="max-w-6xl mx-auto px-6 flex items-center justify-between h-16">
        ...
        <div class="hidden md:flex items-center gap-8 text-white text-sm">
            ...
            <a href="/services" class="hover:text-yellow-400">Service</a>
            <a href="/publication" class="hover:text-yellow-400">Publication</a>
    ...
    <div id="mobile-menu"
        ...
        <a href="/services" class="block">Service</a>
        <a href="/publication" class="block">Publication</a>
